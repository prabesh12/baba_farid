...
export default function ServiceAreasSection({ serviceAreas }: ServiceAreasSectionProps) {
  return (
    <section className="mx-auto w-full max-w-6xl px-6 py-6 md:py-12">
